					...
					<table class="table table-bordered text-center">
						...
						<tbody>
						 <!-- Column-1 -->
						  ...
						  <tr>
							<td><a href="<?php echo base_url('product-detail/'.create_slug($product->ProdTitle.$product->Sku).'?pid='.$product->id); ?>">     <img src="<?php echo base_url('assets/front/images/most-3.jpg'); ?>"></a></td>
