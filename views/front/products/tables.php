	...
	<div class="table-wrap <?php echo ($k%2==0)?'back-img':'back-blue'; ?>">
        ...
        <?php if($k%2==0){ ?>
          <div class="col-md-6">
  					...
  					<a href="<?php echo base_url('product-detail/'.create_slug($product->ProdTitle.$product->Sku).'?pid='.$product->id); ?>" class="btn know-more bg-white mt-2">Request Call Back <i class="fa fa-caret-right"></i></a>
  					</div>
  				</div>
        <div class="col-md-6">
